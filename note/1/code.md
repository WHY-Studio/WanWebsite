...
class App:
    def __init__(self):
        ...
        self.root.title('计算器')
        # 指定窗口大小和默认所处位置
        # self.root.geometry("295x290+150+150")
        self.root.geometry("530x640")
        self.root['background'] = '#ffffff'
        self.root.iconbitmap('ico.ico')
        self.root.minsize(290, 360)
    ...
    def layout(self):
        ...
        label = tk.Label(self.root, textvariable=self.result_num, width=20, height=2,
                        justify='left', anchor='se', bg='#ffffff', font=('宋体', 50))
        # label.grid(row=0, column=0, padx=4, pady=4, columnspan=4)
        label.place(relx = 0,rely = 0,relheight = 0.25,relwidth = 1)
        ...
        button_clear.place(relx = 0.00,rely = 0.25,relheight = 0.15,relwidth = 0.25)
        # 删除键
        ...
        button_back.place(relx = 0.25,rely = 0.25,relheight = 0.15,relwidth = 0.25)
        # 除法
        ...
        button_div.place(relx = 0.50,rely = 0.25,relheight = 0.15,relwidth = 0.25)
        # 乘法
        button_mult = tk.Button(self.root, text='×', width=5, font=('宋体', 16),
                                bg='#C0C0C0', command=lambda: self.operate('×'))
        # button_mult.grid(row=1, column=3, padx=4, pady=4)
        button_mult.place(relx = 0.75,rely = 0.25,relheight = 0.15,relwidth = 0.25)
        ...
        button_seven.place(relx = 0.0,rely = 0.4,relheight = 0.15,relwidth = 0.25)
        ...
        button_eight.place(relx = 0.25,rely = 0.4,relheight = 0.15,relwidth = 0.25)
        ...
        button_nine.place(relx = 0.50,rely = 0.4,relheight = 0.15,relwidth = 0.25)

        button_sub = tk.Button(self.root, text='-', width=5, font=('宋体', 16),
                            bg='#C0C0C0', command=lambda: self.operate('-'))
        # button_sub.grid(row=2, column=3, padx=4, pady=4)
        button_sub.place(relx = 0.75,rely = 0.4,relheight = 0.15,relwidth = 0.25)
        ...
        button_four.place(relx = 0.0,rely = 0.55,relheight = 0.15,relwidth = 0.25)
        ...
        button_five.place(relx = 0.25,rely = 0.55,relheight = 0.15,relwidth = 0.25)
        ...
        button_six.place(relx = 0.5,rely = 0.55,relheight = 0.15,relwidth = 0.25)

        button_add = tk.Button(self.root, text='+', width=5, font=('宋体', 16),
                            bg='#C0C0C0', command=lambda: self.operate('+'))
        # button_add.grid(row=3, column=3, padx=4, pady=4)
        button_add.place(relx = 0.75,rely = 0.55,relheight = 0.15,relwidth = 0.25)
        ...
        button_one.place(relx = 0.0,rely = 0.7,relheight = 0.15,relwidth = 0.25)
        ...
        button_two.place(relx = 0.25,rely = 0.7,relheight = 0.15,relwidth = 0.25)
        ...
        button_three.place(relx = 0.50,rely = 0.7,relheight = 0.15,relwidth = 0.25)
        ...
        button_equal.place(relx = 0.75,rely = 0.7,relheight = 0.3,relwidth = 0.25)
        ...
        button_not.place(relx = 0.0,rely = 0.85,relheight = 0.15,relwidth = 0.25)
        ...
        button_zero.place(relx = 0.25,rely = 0.85,relheight = 0.15,relwidth = 0.25)
        ...
        button_pot.place(relx = 0.50,rely = 0.85,relheight = 0.15,relwidth = 0.25)
